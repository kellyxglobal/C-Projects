...
typedef struct employ employee;
...
void list_emprecords()
{
    ...
    else
    {
        ...
        while (fread(&emp, sizeof(emp), 1, fptr) == 1)
        {
            ...
            for (i = 0; i < emp_Name_Size; i++)      
                printf(" ");

            printf("%s", emp.emp_Country_Code);
            for (i = 0; i < emp_Country_Size; i++)
            printf(" ");

            printf("%s", emp.emp_ID_Card);
            for (i = 0; i < emp_ID_Size; i++)
            printf(" ");

            printf("%ld", emp.emp_Mobile_No);
            for (i = 0; i < emp_Mobile_Size; i++)
            printf(" ");

            printf("%s", emp.emp_gender);
            for (i = 0; i < emp_gender_Size; i++)
            printf(" ");
